...
> Automatic AI-powered keyword tagging for photos in an Adobe Lightroom Classic catalog using local LLMs via Ollama. Fully offline — no cloud uploads, no external APIs.
